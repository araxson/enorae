...
2. **Fix against canonical patterns:**
   - Compare `docs/project-tree-ai.json` with `docs/ruls/architecture.md`
...
**Patterns Reference:** docs/ruls/architecture.md
...
- ✅ All files live in canonical locations per `architecture.md`
