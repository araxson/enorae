---
description: Fix issues found in Business Portal analysis systematically
---

# Fix Business Portal Issues
**Key Principle:** The database is the source of truth. All code must match the database, not the other way around.
You are fixing issues from the Business Portal deep analysis.

## Context

The Business Portal analysis created 9 files in `docs/business-portal/`:
...
Fix issues from the Business Portal analysis systematically and safely.
...
4. **MARKDOWN TODO LIST REQUIRED**:
   - Create a markdown file `docs/business-portal/fix-progress.md` at the start
...
Ask the user:
```
Which Business Portal issues should I fix?
...
- Layer 1: `docs/business-portal/01_PAGES_ANALYSIS.md`
- Layer 2: `docs/business-portal/02_QUERIES_ANALYSIS.md`
- Layer 3: `docs/business-portal/03_MUTATIONS_ANALYSIS.md`
- Layer 4: `docs/business-portal/04_COMPONENTS_ANALYSIS.md`
- Layer 5: `docs/business-portal/05_TYPES_ANALYSIS.md`
- Layer 6: `docs/business-portal/06_VALIDATION_ANALYSIS.md`
- Layer 7: `docs/business-portal/07_SECURITY_ANALYSIS.md`
- Layer 8: `docs/business-portal/08_UX_ANALYSIS.md`
...
Create `docs/business-portal/fix-progress.md`:
```markdown
...
1. ✅ Issue #1 - features/business/[...]:line - [description]
2. ✅ Issue #2 - features/business/[...]:line - [description]
...
- **Portal**: Business only (features/business/, app/(business)/)
