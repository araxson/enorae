Focus on customer portal # UI/UX Comprehensive Audit & Fix
...
- `Item` - Semantic layout primitive for customer surfaces
...
Mirror the customer portal reports in `docs/ui-ux-reports/`—especially `docs/ui-ux-reports/customer-portal-layout-audit.md`. Keep the exact section order and formatting conventions:
...
12. Store new reports under `docs/ui-ux-reports/customer/01-<slug>.md`, using zero-padded numeric prefixes for ordering.
