Focus on business portal # UI/UX Comprehensive Audit & Fix
...
- `Item` - Semantic layout primitive for business surfaces
...
Mirror the business portal reports in `docs/ui-ux-reports/`—especially `docs/ui-ux-reports/business-portal-layout-audit.md`. Keep the exact section order and formatting conventions:
...
12. Store new reports under `docs/ui-ux-reports/business/01-<slug>.md`, using zero-padded numeric prefixes for ordering.
