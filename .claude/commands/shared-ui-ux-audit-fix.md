Focus on shared portal # UI/UX Comprehensive Audit & Fix
...
- `Item` - Semantic layout primitive for shared surfaces
...
Mirror the shared portal reports in `docs/ui-ux-reports/`—especially `docs/ui-ux-reports/shared-portal-layout-audit.md`. Keep the exact section order and formatting conventions:
...
12. Store new reports under `docs/ui-ux-reports/shared/01-<slug>.md`, using zero-padded numeric prefixes for ordering.
