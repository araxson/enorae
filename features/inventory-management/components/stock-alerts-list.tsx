...
import { resolveStockAlert } from '../actions/inventory.actions'
import type { StockAlertWithProduct } from '../dal/inventory.queries'
  ...
  return (
    <Card>
      ...
      <CardContent>
        <Stack gap="sm">
          {alerts.map((alert) => {
            const alertInfo = getAlertType(alert.alert_type)
