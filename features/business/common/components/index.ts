...
// DEPRECATED: Use from '@/features/shared/ui/components' instead
export { MetricCard } from '@/features/shared/ui/components/metric-card'
export type { MetricCardVariant } from '@/features/shared/ui/components/metric-card'
...
export { RevenueCardBreakdown } from './revenue-card-breakdown'
export { RevenueTrendChart } from './revenue-trend-chart'
export { BusinessSalonSwitcher } from './salon-switcher'
export { BusinessSalonSwitcherClient } from './salon-switcher-client'
...
export { formatCurrency, formatPercentage } from '../utils/value-formatters'
