...
type ScopedQueryResult = Awaited<ReturnType<typeof getScopedQuery>>
type StockAlertQueryBuilder = ScopedQueryResult['baseQuery']

async function fetchAlertList(modify?: (query: StockAlertQueryBuilder) => StockAlertQueryBuilder) {
