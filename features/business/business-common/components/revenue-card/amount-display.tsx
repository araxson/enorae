...
import { formatCurrency, formatPercentage } from '@/features/business/business-common/utils/value-formatters'
 ...
 */
export function AmountDisplay({ amount, growthRate, currency, compact }: AmountDisplayProps) {
