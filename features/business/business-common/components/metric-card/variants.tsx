 ...
 */
export function DefaultVariant({ value, subtitle }: Extract<MetricCardProps, { variant?: 'default' }>) {
  return (
...
export function ProgressVariant({
  ...
  subtitle,
  progressClass,
}: Extract<MetricCardProps, { variant: 'progress' }>) {
  return (
    <div className="flex flex-col gap-2">
      <p className={METRIC_VALUE_CLASS}>{value}</p>
      <Progress
...
export function TrendVariant({
  ...
  trend,
  subtitle,
}: Extract<MetricCardProps, { variant: 'trend' }>) {
  return (
    <div className="flex flex-col gap-2">
...
export function HighlightVariant({
  ...
  highlight,
  subtitle,
}: Extract<MetricCardProps, { variant: 'highlight' }>) {
  return (
    <div className="flex flex-col gap-2">
      <p className={METRIC_VALUE_CLASS}>{value}</p>
      {highlight}
