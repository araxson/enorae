...
import type { AppointmentService, Appointment, ServiceStats, StaffStats } from '@/features/business/analytics/api/types'
...
export async function getTopServices(
  ...
  const logger = createOperationLogger('getTopServices', {})
  logger.start()
