...
const learningTracks = [
  { title: 'Scheduling mastery', duration: '18 mins', level: 'Intermediate', tags: ['Calendar', 'Automation'] as string[] },
  { title: 'Client retention playbook', duration: '25 mins', level: 'Advanced', tags: ['Relationships', 'Growth'] as string[] },
  { title: 'Salon safety refresh', duration: '12 mins', level: 'Foundational', tags: ['Policy', 'Compliance'] as string[] },
] as const

export async function getStaffHelpOverview() {
  return {
    summaryCards,
    quickActions,
    resourceCategories,
