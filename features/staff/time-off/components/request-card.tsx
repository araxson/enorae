      ...
      <Stack gap="sm">
        <Flex justify="between" align="start">
          <Box>
            ...
            <Small className="text-muted-foreground capitalize">{request.request_type?.replace('_', ' ') || 'N/A'}</Small>
          </Box>
          <Badge variant={getStatusVariant(request.status || '')}>{request.status || 'Unknown'}</Badge>
        </Flex>
